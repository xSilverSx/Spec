...
2.	**Стиль R1C1:** меняет стили таблиц Excel на R1C1 или A1 соответсвенно.
...
4.	**Обновление спецификации:** Заменяет старую спецификацию новой, для использования со старыми версиями файлов.
